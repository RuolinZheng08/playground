...
AddRecordDialog::AddRecordDialog(wxWindow *parent): wxDialog(parent, wxID_ANY, _T("Add New Record"), wxDefaultPosition, wxSize(400, 350)) {
    ...
    wxStaticBox *contentBox = new wxStaticBox(this, wxID_ANY, _T("New record"), wxPoint(10, 10), wxSize(380, 300));
    ...
    contentSizer->Add(nameSizer, 0, wxTOP | wxBOTTOM | wxALIGN_CENTER_HORIZONTAL, MEDIUM_SPACING);
    ...
    contentSizer->Add(mRbTokType, 0, wxTOP | wxBOTTOM | wxALIGN_CENTER_HORIZONTAL, MEDIUM_SPACING);
    ...
    contentSizer->Add(numSizer, 0, wxTOP | wxBOTTOM | wxALIGN_CENTER_HORIZONTAL, MEDIUM_SPACING);
    ...
    controlSizer->AddSpacer(40);
    controlSizer->Add(btnOk, 0);
    dialogSizer->Add(contentBox, 1, wxALIGN_CENTER | wxEXPAND); // will crash if add contentSizer instead of contentBox
